...
import rdevs.mtmt.filter.IF1977Filter;
import rdevs.mtmt.filter.IFAmaroFilter;
import rdevs.mtmt.filter.IFBrannanFilter;
import rdevs.mtmt.filter.IFEarlybirdFilter;
import rdevs.mtmt.filter.IFHefeFilter;
import rdevs.mtmt.filter.IFHudsonFilter;
import rdevs.mtmt.filter.IFInkwellFilter;
import rdevs.mtmt.filter.IFLomoFilter;
import rdevs.mtmt.filter.IFLordKelvinFilter;
import rdevs.mtmt.filter.IFNashvilleFilter;
import rdevs.mtmt.filter.IFRiseFilter;
import rdevs.mtmt.filter.IFSierraFilter;
import rdevs.mtmt.filter.IFSutroFilter;
import rdevs.mtmt.filter.IFToasterFilter;
import rdevs.mtmt.filter.IFValenciaFilter;
import rdevs.mtmt.filter.IFWaldenFilter;
import rdevs.mtmt.filter.IFXprollFilter;
