...
public class ColorSeekBar extends View {
    public static int defaultColor = 0xFF0000FF;
    ...
    protected void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        //init color
        defaultColor = pickColor(mColorBarValue);
        setAlphaValue();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int[] toAlpha = new int[]{Color.argb(0, mRed, mGreen, mBlue), Color.argb(255, mRed, mGreen, mBlue)}; // interchanged
        //clear
     ...
     * @return color
     */
    public int pickColor(float position) {
